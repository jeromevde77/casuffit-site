...
header('Expires: 0');
// index.php — Site Piste01 Ça Suffit ASBL (v2 - look ancien site)
...
<header class="site-header">
  <div class="header-inner">
    <div class="logo-wrap">
      <img src="medias/logo.png" alt="Piste01 Ça Suffit ASBL" onerror="this.style.display='none'">
    </div>
...
<footer id="pied">
  ...
  <div class="pied-bottom">
    <span id="copyright-trigger" onclick="handleAdminClick()" style="cursor:default;user-select:none">© <?= date('Y') ?> Piste 01, Piste01 Ça Suffit ASBL &nbsp;·&nbsp; Tous droits réservés</span>
