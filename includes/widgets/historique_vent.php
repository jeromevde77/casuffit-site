...
window.pmhExport = function(){
  ...
  var html='<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8">'
    ...
    +'<div class="logo">Piste01 Ça Suffit ASBL</div>'
    +'</div>'
    +'<div class="meta">'
    ...
    +'<div class="footer">'
    +'<span>Document généré le '+new Date().toLocaleString('fr-BE',{timeZone:'Europe/Brussels',day:'2-digit',month:'2-digit',year:'numeric',hour:'2-digit',minute:'2-digit'})+' · Piste01 Ça Suffit ASBL — casuffit.be</span>'
