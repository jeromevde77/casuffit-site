...
.wct-link:hover{opacity:.85}.wct-link.wct-email{background:#0e3d6b}.wct-link.wct-fb{background:#1877f2}
...
.wct-group{margin-bottom:12px}.wct-group label{display:block;font-size:.8rem;font-weight:700;color:#0e3d6b;margin-bottom:3px}
