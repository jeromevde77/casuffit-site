<?php
// Widget contact — NL
// Anti-bot : rekenvraag + tijdstempel in sessie
...
<div class="wct-form-title" style="font-size:1rem;font-weight:700;color:#0e3d6b;margin-bottom:14px">📝 Stuur een bericht</div>
...
<form id="wct-form" onsubmit="wctSubmit(event)">
  ...
  <div class="wct-group">
    <label>Anti-spam : hoeveel is <?= $wct_a ?> + <?= $wct_b ?> ? *</label>
    <input type="text" name="captcha" inputmode="numeric" required placeholder="Uw antwoord" autocomplete="off" style="max-width:180px">
  </div>
  <!-- Honeypot -->
...
<div class="wct-links">
  <a class="wct-link wct-email" href="mailto:<?= function_exists('mailto_bcc') ? mailto_bcc('info@casuffit.be') : 'info@casuffit.be' ?>">✉ info@casuffit.be</a>
