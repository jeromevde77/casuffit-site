  ...
  <p style="font-size:11px;color:#aaa;margin:0">
    ...
    return [
        ...
        'magic_link' => [
            ...
            'sujet_fr'  => 'Votre accès espace membre — Ça suffit !',
...
. $footer(),
        ...
        'invite_membre' => [
            ...
            'sujet_fr'  => 'Votre espace membre vous attend — Ça suffit !',
...
. $footer(),
        ...
        'confirm_newsletter' => [
            ...
            'sujet_fr'  => 'Confirmez votre abonnement — Ça suffit !',
...
. '<p style="font-size:15px;font-weight:700;color:#0e3d6b;margin:0 0 16px">Bonjour {{prenom}},</p>
<p style="font-size:14px;color:#555;line-height:1.6;margin:0 0 20px">
  Merci de votre intérêt pour Ça suffit !.<br>
...
. $footer(),
        ...
        'confirm_email' => [
            ...
            'sujet_fr'  => 'Confirmez votre nouvel email — Ça suffit !',
