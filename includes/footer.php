  ...
  <div style="max-width:1000px;margin:0 auto;display:grid;grid-template-columns:1fr 1fr 1fr;gap:24px;flex-wrap:wrap">
    <div>
      ...
      <div style="font-size:0.75rem;color:rgba(255,255,255,0.6);line-height:1.8">
        ...
        <a href="mailto:<?= function_exists('mailto_bcc') ? mailto_bcc() : htmlspecialchars(cfg('site_email','info@casuffit.be')) ?>" style="color:rgba(255,255,255,0.7)"><?= htmlspecialchars(cfg('site_email','info@casuffit.be')) ?></a>
      </div>
