...
<?php include __DIR__ . '/../includes/admin_pwa_head.php'; ?>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .pitem{padding:10px 12px;cursor:pointer;border-bottom:1px solid #f0f4f8;transition:background .1s;display:flex;align-items:center;gap:10px}
    .pitem:hover{background:#f5f8fc}
    ...
    .pitem-flag-nl-ok{background:#fff3cd;color:#856404}
    .pitem-flag-nl-auto{background:#fff7e6;color:#d97706}
    .pitem-flag-nl-no{background:#f0f0f0;color:#bbb}
    .pitem-acts{display:flex;gap:3px;flex-shrink:0}
...
#wysiwyg-editor .content-text , #wysiwyg-editor-nl .content-text { color: #1673B2; }
...
#wysiwyg-editor .section-title , #wysiwyg-editor-nl .section-title { color: #FF9900; font-weight: 400; font-size: 1.1rem; margin: 20px 0 8px; padding-bottom: 4px; border-bottom: 1px solid #c8dff0; }
#wysiwyg-editor .orange.section-title, #wysiwyg-editor div.orange.section-title, #wysiwyg-editor h3.orange , #wysiwyg-editor-nl .orange.section-title, #wysiwyg-editor div.orange.section-title, #wysiwyg-editor h3.orange { color: #FF9900; font-weight: 400; font-size: 1.05rem; margin: 20px 0 8px; padding-bottom: 4px; border-bottom: 1px solid #c8dff0; }
...
#wysiwyg-editor .chiffres-grid , #wysiwyg-editor-nl .chiffres-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(150px,1fr)); gap: 10px; margin: 14px 0; }
#wysiwyg-editor .chiffre-card  , #wysiwyg-editor-nl .chiffre-card { background: #e8f3fb; border-top: 3px solid #1673B2; padding: 14px; text-align: center; }
/* Timeline */
#wysiwyg-editor .timeline      , #wysiwyg-editor-nl .timeline { position: relative; padding-left: 24px; margin: 14px 0; }
#wysiwyg-editor .timeline::before , #wysiwyg-editor-nl .timeline::before { content: ""; position: absolute; left: 6px; top: 0; bottom: 0; width: 2px; background: #c8dff0; }
#wysiwyg-editor .tl-item       , #wysiwyg-editor-nl .tl-item { position: relative; margin-bottom: 14px; }
#wysiwyg-editor .tl-item::before , #wysiwyg-editor-nl .tl-item::before { content: ""; position: absolute; left: -20px; top: 5px; width: 10px; height: 10px; border-radius: 50%; background: #1673B2; border: 2px solid #fff; box-shadow: 0 0 0 2px #1673B2; }
#wysiwyg-editor .tl-item.bad::before , #wysiwyg-editor-nl .tl-item.bad::before { background: #FF9900; box-shadow: 0 0 0 2px #FF9900; }
#wysiwyg-editor .tl-date       , #wysiwyg-editor-nl .tl-date { font-weight: 600; font-size: 85%; color: #1673B2; }
#wysiwyg-editor .tl-item.bad .tl-date , #wysiwyg-editor-nl .tl-item.bad .tl-date { color: #cc7a00; }
...
#wysiwyg-editor .divider       , #wysiwyg-editor-nl .divider { display: flex; align-items: center; gap: 10px; margin: 16px 0; color: #555; font-size: 72%; font-weight: 400; text-transform: uppercase; letter-spacing: .08em; }
#wysiwyg-editor .divider::before, #wysiwyg-editor .divider::after , #wysiwyg-editor-nl .divider::before, #wysiwyg-editor .divider::after { content: ""; flex: 1; height: 1px; background: #c8dff0; }
/* Demandes */
#wysiwyg-editor .demandes-list , #wysiwyg-editor-nl .demandes-list { list-style: none; padding: 0; margin: 12px 0; }
#wysiwyg-editor .demande-item  , #wysiwyg-editor-nl .demande-item { display: flex; gap: 14px; align-items: flex-start; padding: 12px 0; border-bottom: 1px solid #c8dff0; }
#wysiwyg-editor .demande-item:last-child , #wysiwyg-editor-nl .demande-item:last-child { border-bottom: none; }
#wysiwyg-editor .demande-num   , #wysiwyg-editor-nl .demande-num { width: 32px; height: 32px; background: #1673B2; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 90%; flex-shrink: 0; margin-top: 2px; }
/* Fiscal */
#wysiwyg-editor .fiscal-box    , #wysiwyg-editor-nl .fiscal-box { background: #fffdf0; border: 1px solid #fcd99a; padding: 10px 14px; margin-bottom: 14px; display: flex; gap: 10px; align-items: flex-start; }
#wysiwyg-editor .fiscal-text   , #wysiwyg-editor-nl .fiscal-text { font-size: 78%; color: #7a5010; line-height: 1.4; }
/* Virement */
#wysiwyg-editor .virement-box  , #wysiwyg-editor-nl .virement-box { background: #f9f9f9; border: 1px solid #c8dff0; padding: 14px 16px; margin-bottom: 14px; }
#wysiwyg-editor .iban-row      , #wysiwyg-editor-nl .iban-row { display: flex; align-items: center; justify-content: space-between; gap: 8px; flex-wrap: wrap; }
#wysiwyg-editor .iban-val      , #wysiwyg-editor-nl .iban-val { font-family: monospace; font-size: .9rem; font-weight: 700; color: #0e5a96; margin-bottom: 3px; }
#wysiwyg-editor .iban-bank     , #wysiwyg-editor-nl .iban-bank { font-size: 70%; color: #555; }
#wysiwyg-editor .comm-box      , #wysiwyg-editor-nl .comm-box { margin-top: 10px; background: rgba(255,153,0,0.08); border: 1px dashed #FF9900; padding: 8px 12px; }
#wysiwyg-editor .comm-label    , #wysiwyg-editor-nl .comm-label { font-size: 65%; font-weight: 600; text-transform: uppercase; letter-spacing: .08em; color: #cc7a00; margin-bottom: 2px; display: block; }
#wysiwyg-editor .comm-val      , #wysiwyg-editor-nl .comm-val { font-size: 82%; font-style: italic; color: #1673B2; }
/* Misc */
#wysiwyg-editor .dc-titre      , #wysiwyg-editor-nl .dc-titre { font-weight: 600; color: #1673B2; font-size: 95%; margin-bottom: 4px; }
#wysiwyg-editor .dc-text       , #wysiwyg-editor-nl .dc-text { font-size: 85%; color: #555; margin: 0; }
...
#wysiwyg-editor h3             , #wysiwyg-editor-nl h3 { color: #0e3d6b; font-weight: 600; font-size: 1.05rem; margin: 14px 0 6px; }
#wysiwyg-editor ul, #wysiwyg-editor ol , #wysiwyg-editor-nl ul, #wysiwyg-editor ol { padding-left: 20px; margin: 8px 0; }
#wysiwyg-editor li             , #wysiwyg-editor-nl li { margin-bottom: 4px; line-height: 1.5; }
...
<div class="wrap view-edit">
  ...
  <div class="plist">
    ...
    <div class="plist-body">
      ...
      <?php
      // Trier : parents d'abord, puis enfants juste après leur parent
      $parents  = array_filter($pages, fn($p) => !$p['parent_id']);
      $children = [];
      foreach ($pages as $p) { if ($p['parent_id']) $children[$p['parent_id']][] = $p; }
      $sorted = [];
      foreach ($parents as $p) {
          $sorted[] = ['page' => $p, 'is_child' => false];
          foreach ($children[$p['id']] ?? [] as $c) {
              $sorted[] = ['page' => $c, 'is_child' => true];
          }
      }
          ...
          <div class="pitem-meta">
            ...
            <?php if ($has_nl): ?>
              <?php if ($nl_status === 'relu'): ?>
                <span class="pitem-flag pitem-flag-nl-ok">🇳🇱 ✓</span>
              <?php elseif ($nl_status === 'auto'): ?>
                <span class="pitem-flag pitem-flag-nl-auto">🇳🇱 ~</span>
              <?php else: ?>
                <span class="pitem-flag pitem-flag-nl-ok">🇳🇱</span>
              <?php endif; ?>
            <?php else: ?>
              <span class="pitem-flag pitem-flag-nl-no">NL ?</span>
            <?php endif; ?>
          </div>
        </div>
...
var BLOCS = {
  ...
  bq:        '<blockquote>Citation mise en valeur.</blockquote>',
  signature: '<div class="signature">Cordialement,<strong>L\'équipe Piste01 Ça Suffit ASBL</strong></div>',
