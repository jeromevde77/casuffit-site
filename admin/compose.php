...
$site_nom = cfg('site_nom', 'Piste01 Ça Suffit ASBL');
...
function buildEmailPreview($sujet, $contenu, $site_nom, $iban, $annee) {
    ...
    <div style="background:#0e3d6b;padding:20px 28px;text-align:center">
      <div style="color:#fff;font-size:1.3rem;font-weight:800"><span style="color:#FF9900">Piste01 Ça Suffit</span> ASBL</div>
    ...
    <div style="background:#f5f8fc;padding:16px 28px;border-top:2px solid #e0e8f0;font-size:.72rem;color:#888;text-align:center">
      <p style="margin-bottom:4px"><strong style="color:#0e3d6b">Piste01 Ça Suffit ASBL</strong> · ' . htmlspecialchars($iban) . '</p>
