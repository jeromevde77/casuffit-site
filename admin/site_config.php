...
<div class="main">
  ...
  <form method="POST" enctype="multipart/form-data"><?= csrf_field() ?>
    ...
    <div class="card">
      ...
      <input type="text" name="site_nom" value="<?= htmlspecialchars($c['site_nom'] ?? 'Piste01 Ça Suffit ASBL') ?>">
      <label>Slogan</label>
    ...
    <div class="card">
      ...
      <input type="text" name="beneficiaire" value="<?= htmlspecialchars($c['beneficiaire'] ?? 'Piste01 Ça Suffit ASBL') ?>">
